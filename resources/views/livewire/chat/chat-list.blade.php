<div class="flex flex-col transition-all h-full overflow-hidden" x-data="{ type: 'all' }">
          ...
          >
            ...
            <div class="flex gap-x-2 items-center">
              ...
              <p class="grow truncate text-sm font-[100]">Lorem ipsum dolor sit, amet consectetur
                adipisicing elit. Soluta itaque aspernatur id rerum, maxime ab beatae. Quis unde
                velit rem, officiis vel atque corporis! Nemo cupiditate blanditiis voluptas ad
                ipsum!</p>
